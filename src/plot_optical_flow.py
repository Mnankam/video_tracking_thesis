...
def main():
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(os.path.join(out_dir, "optical_flow_y.png"), dpi=150)
    plt.close()
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(os.path.join(out_dir, "optical_flow_dy.png"), dpi=150)
    plt.close()
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(os.path.join(out_dir, "optical_flow_x.png"), dpi=150)
    plt.close()
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(os.path.join(out_dir, "optical_flow_dx.png"), dpi=150)
    plt.close()
